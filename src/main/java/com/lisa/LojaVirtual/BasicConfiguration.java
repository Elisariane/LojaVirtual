...
public class BasicConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				...
				.hasAnyAuthority("Gerente", "Vendedor").and().formLogin().loginPage("/login").permitAll().and().logout()
...
//		http.authorizeRequests().antMatchers("/administrativo/**").hasAnyAuthority("Gerente", "Funcionario")
//				.antMatchers(
//
//						"/administrativo/entrada/**"
//
//				).hasAnyAuthority("Gerente").and().formLogin().loginPage("/login").permitAll().and().logout()
